                ...
                <Link to="/kamrej">
                  <div className="item">
                    <div className="item-inner">
                      ...
                      <div className="farm-name">Daisy villa <span>[Kamrej]</span></div>
                    </div>
                  </div>
                </Link>
                <Link to="/palsana">
                  <div className="item">
                    <div className="item-inner">
                      ...
                      <div className="farm-name">Orange villa <span>[Palsana]</span></div>
                    </div>
                  </div>
                </Link>
                <Link to="/sayanolpad">
                  <div className="item">
                    <div className="item-inner">
                      ...
                      <div className="farm-name">Lily farm house Villa <span>[Sayan & Olpad]</span></div>
                    </div>
                  </div>
                </Link>
